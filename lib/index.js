...
function displayDiaryIndex (mealsArray) {
	var breakfastTable = document.getElementByClassName("breakfast")
	var lunchTable     = document.getElementByClassName("luch")
	var dinnerTable    = document.getElementByClassName("dinner")
	var snackTable     = document.getElementByClassName("snack")
	buildTable(breakfastTable, mealsArray.breakfast);
  buildTable(lunchTable, mealsArray.lunch);
  buildTable(dinnerTable, mealsArray.dinner);
  buildTable(snackTable, mealsArray.snack);
}

function buildTable(tableElement, foodsArray) {
