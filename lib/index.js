...
function displayDiaryIndex (mealsArray) {
	...
	buildTable(breakfastTable, mealsArray.rows.breakfast);
  buildTable(lunchTable, mealsArray.rows.lunch);
  buildTable(dinnerTable, mealsArray.rows.dinner);
  buildTable(snackTable, mealsArray.rows.snack);
}
